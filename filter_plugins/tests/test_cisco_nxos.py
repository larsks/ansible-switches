...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            marks=pytest.mark.xfail(reason="code wants mode, config files have type"),
        ),
        pytest.param(
            ...
            marks=pytest.mark.xfail(reason="code wants port-channel, config files have Port-channel"),
        ),
    ],
)
